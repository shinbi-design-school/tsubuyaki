	...
	<main>
		<form method="post" action="user">
			<table id="user_table">
				...
				<tr>
					<th>権限</th>
					<td><input type="radio" name="is_admin" value="true"
						<%= adminOption %>> 管理者 <input type="radio"
						name="is_admin" value="false" <%= userOption %>> 一般</td>
				</tr>
				<tr>
					<th>パスワード</th>
				...
				<tr>
					<td><input id="submit" type="submit" value="<%= submitName %>">
					</td>
				</tr>
			</table>
			<input type="hidden" name="id" value="<%= id %>"> <input
				type="hidden" name="operation" value="<%= operationName %>">
		</form>
		<%
    if(error != null) {
%>
